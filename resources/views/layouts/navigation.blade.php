<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 fixed top-0 left-0 w-full z-50">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('dataInput')" :active="request()->routeIs('dataInput')">
                {{ __('Data Input') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('dataTable')" :active="request()->routeIs('dataTable')">
                {{ __('Data Table') }}
            </x-responsive-nav-link>
